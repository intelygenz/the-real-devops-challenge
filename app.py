...
app = Flask(__name__)
app.config["MONGO_URI"] = 'mongodb+srv://justor7777777:u1jDyDKCzcSoCTo3@cluster0.mxl6ikk.mongodb.net/intelygenz?retryWrites=true&w=majority'#environ.get("MONGO_URI")
